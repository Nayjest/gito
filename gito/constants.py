...
EXECUTABLE = "gito"
TEXT_ICON_URL = 'https://raw.githubusercontent.com/Nayjest/Gito/main/press-kit/logo/gito-bot-1_64top.png'
HTML_TEXT_ICON = (
    '<a href="https://github.com/Nayjest/Gito">'
    f'<img src="{TEXT_ICON_URL}" align="left" width=64 height=50 />'
    '</a>'
)
